...
//BLUFF CODE
    ...
    mysql_query("UPDATE oth_15 SET startlevel=5 WHERE tek_name='$tek_name'");
...
if(isset($_POST['answer']))
	{
		...
		if(strcasecmp ( $rightans1, $answer) == 0)
		{
			...
			mysql_query("UPDATE oth_15 SET level=5, ctime=NOW(),score=175 WHERE tek_name='$tek_name'");
			...
			<p style="color: #ffffff;font-family: 'carbon'; font-size: 21px; margin-top: 3%;">SCORE: 175</p>
		     ...
		     <div id="Textt" ><center>
				<p class="para">
				  ...
				  he needs to find some basic requirements, to store into his backpack.
				</p>
				</center>
