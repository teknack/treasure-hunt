...
//BLUFF CODE
    ...
    mysql_query("UPDATE oth_16 SET startlevel=3 WHERE tek_emailid='$tek_emailid'");
...
if(isset($_POST['answer']))
	{
		...
		if(strcasecmp ( $rightans1, $answer) == 0)
		{
			...
			mysql_query("UPDATE oth_16 SET level=3, ctime=NOW(),score=75 WHERE tek_emailid='$tek_emailid'");
