...
//BLUFF CODE
    ...
    mysql_query("UPDATE oth_16 SET startlevel=7 WHERE tek_emailid='$tek_emailid'");
...
if(isset($_POST['answer']))
	{
		...
		if(strcasecmp ( $rightans1, $answer) == 0)
		{
			...
			mysql_query("UPDATE oth_16 SET level=7, ctime=NOW(),score=275 WHERE tek_emailid='$tek_emailid'");
