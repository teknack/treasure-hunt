...
require_once ('php/quit.php');
  ...
  $tek_emailid = $_SESSION['tek_emailid'];
    ...
    mysql_query("UPDATE oth_16 SET startlevel=14 WHERE tek_emailid='$tek_emailid'");
...
if(isset($_POST['answer']))
	{
		...
		if(strcasecmp ( $rightans1, $answer) == 0)
		{
			...
			sendScore("treasure-hunt",250,$_SESSION["tek_emailid"]);
			mysql_query("UPDATE oth_16 SET level=14, ctime=NOW(),score=1000 WHERE tek_emailid='$tek_emailid'");
