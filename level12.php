...
require_once ('php/quit.php');
  ...
  $tek_name = $_SESSION['tek_name'];
    ...
    mysql_query("UPDATE oth_15 SET startlevel=12 WHERE tek_name='$tek_name'");
...
if(isset($_POST['answer']))
	{
		...
		if(strcasecmp ( $rightans1, $answer) == 0)
		{
			...
			mysql_query("UPDATE oth_15 SET level=12, ctime=NOW(),score=700 WHERE tek_name='$tek_name'");
