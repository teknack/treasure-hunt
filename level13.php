...
require_once ('php/quit.php');
  ...
  $tek_name = $_SESSION['tek_name'];
    ...
    mysql_query("UPDATE oth_15 SET startlevel=13 WHERE tek_name='$tek_name'");
...
if(isset($_POST['answer']))
	{
		...
		if(strcasecmp ( $rightans1, $answer) == 0)
		{
			...
			mysql_query("UPDATE oth_15 SET level=13, ctime=NOW(),score=750 WHERE tek_name='$tek_name'");
	  ...
	  LEVELS LEFT: 2 <br> </p>
			...
			<div class="levelcontainr" align="left" >
		     <div id="Textt"  >
			   <center>
				<p class="para">
			       After collecting and sheltering the people from the location 1 (Bibi ka Macqbara). Kane  moves Forward.
				</p>
				</center>
			...
			<div class="levelcontain"  >
		     <div id="Textt"  >
			   <center>
				<p class="para">
				 It was feast time of a famous saint, a tree canopy replaced the roof of this ancient structure. The celebration was held in the 'ruins' of this ancient holy structure which was built in the year of 1579 in the city of dreams.
				<br>
