...
if(isset($_POST['answer']))
	{
		...
		else
		{
			...
			echo '<script>window.top.location="level6.php";</script>';
		}
	}
	...
	<body bgcolor="black">
		...
		<div class="level6">
		 <div class="leveldetails">
			...
			<p style="color: #ffffff;font-family: 'carbon'; font-size: 21px; margin-top: 3%;"> LEVEL 6 </p>
			</div>
...
<div id="element_to_pop_up">
	...
	<center>
	  ...
	  LEVELS LEFT: 9 <br> </p>
			...
			<p style="color: #ffffff;font-family: 'carbon'; font-size: 21px; margin-top: 3%;">SCORE: 225</p>
			</div>
         </div>		 
		 <br>
			<br>
		    ...
		    <div id="Textt" >
			    <center>
				<p class="para"> Item Added: Water , You next Clue is .....
				</p>
                </center> 
			</div>	
		   </div>
			...
			<br>
		     ...
		     <div id="Textt" >
			    <center>
				<p class="para">
				"Magnifera Indica is the king of this food kingdom"
				Our kingdom member enlightened Newton with a hit on his head literally!
				</p>
                </center> 
			</div>	
		   </div>
